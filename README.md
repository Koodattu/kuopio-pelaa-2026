...
kaikki on ohi”**. Ohjelma on kaksituntinen kokonaisuus: noin 60 minuutin
...
- [SuomiWoW-showcase](docs/project-showcase-plan.md) — oman projektin ja sen
  CCG-ominaisuuden kahdeksan minuutin live-demo.
...
Repositorio sisältää tällä hetkellä suunnitelman, ei vielä esitys- tai
workshop-sovellusta. Lähdepankin luvut ovat toimitetusta taustamateriaalista ja
ne tarkistetaan alkuperäislähteistä ennen yleisölle näytettävien kuvaajien
tekemistä.
